            ...
            <Section className="py-16">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex gap-4">
                            {[Facebook, Instagram, Twitter, Linkedin].map((Icon, i) => (
                                <Link key={i} href="#" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-gold hover:text-royal transition-colors">
                                    <Icon size={20} />
                                </Link>
                            ))}
                        </div>
                    ...
                    <div className="grid grid-cols-2 gap-8">
                        <div>
                            ...
                            <ul className="space-y-2 text-white/70">
                                {["About Us", "Leadership", "Faculty", "Careers", "News"].map(li => (
                                    <li key={li}><Link href="#" className="hover:text-gold transition-colors">{li}</Link></li>
                                ))}
                            </ul>
                        </div>
                        <div>
                            ...
                            <ul className="space-y-2 text-white/70">
                                {["Curriculum", "Co-Curricular", "Sports", "Results", "Calendar"].map(li => (
                                    <li key={li}><Link href="#" className="hover:text-gold transition-colors">{li}</Link></li>
                                ))}
                            </ul>
                        </div>
                ...
                <div className="border-t border-white/10 mt-16 pt-8 text-center text-white/40 text-sm flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div className="flex gap-6">
                        ...
                        <Link href="#" className="hover:text-gold">Terms of Use</Link>
                    </div>
                </div>
            </Section>
        </footer>
